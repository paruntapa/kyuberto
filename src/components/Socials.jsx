  ...
  return (
    <div className="w-full min-h-screen bg-black pt-20 md:pt-32">
      <VelocityScroll numRows={1} defaultVelocity={100}>
        <h1 className="text-8xl md:text-[12rem] text-white font-regular px-10 tracking-tighter">
          Follow Us
        </h1>
        <CircularPing />
      </VelocityScroll>
      ...
      <div className="w-full mt-20">
        <h1 className="uppercase text-lg md:text-sm text-white font-light-regular px-6 md:px-20 pt-16 pb-8 md:py-12 border-b-1 border-white/20">
      ...
      <div className="mx-1 md:px-20 flex flex-col md:flex-row ml-5  py-24">
