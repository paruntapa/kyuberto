...
export const CardLink = ({ imageUrl, href, title, icon }) => {
  return (
    <div className="flex flex-col gap-6 aspect-video w-108 md:w-120 rounded-4xl">
      ...
      <h1 className=" font-light-regular text-xl md:text-lg text-white">
        {icon} {title}
      </h1>
    </div>
  );
...
// eslint-disable-next-line
export const CardLink1 = ({ imageUrl, href, title, icon }) => {
  return (
