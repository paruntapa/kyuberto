...
const cards = [
    { imageUrl: "/cover/1.png", href: '/image', title: "Cuberto", icon: <Dribbble className='h-6 md:h-4' /> },
    { imageUrl: "/cover/2.png", href: '/image', title: "Cuberto", icon: <Dribbble className='h-6 md:h-4' /> },
    { imageUrl: "/cover/3.png", href: '/image', title: "Cuberto", icon: <Dribbble className='h-6 md:h-4' /> },
    { imageUrl: "/cover/4.png", href: '/image', title: "Cuberto", icon: <Dribbble className='h-6 md:h-4' /> },
    { imageUrl: "/cover/5.png", href: '/image', title: "Cuberto", icon: <Dribbble className='h-6 md:h-4' /> },
    { imageUrl: "/cover/6.jpg", href: '/image', title: "Cuberto", icon: <Dribbble className='h-6 md:h-4' /> },
    { imageUrl: "/cover/7.png", href: '/image', title: "Cuberto", icon: <Dribbble className='h-6 md:h-4' /> },
    { imageUrl: "/cover/8.png", href: '/image', title: "Cuberto", icon: <Dribbble className='h-6 md:h-4' /> },
    { imageUrl: "/cover/9.png", href: '/image', title: "Cuberto", icon: <Dribbble className='h-6 md:h-4' /> },
    { imageUrl: "/cover/10.png", href: '/image', title: "Cuberto", icon: <Dribbble className='h-6 md:h-4' /> },
]
    ...
    return (
        <div className='mt-45 relative flex w-full flex-col items-center justify-center overflow-hidden -top-20 md:mb-20' >
            <VelocityScroll numRows={1} defaultVelocity={100}>
                ...
                className="text-[8rem] md:text-[12rem]  ml-48 md:ml-64">New Day -</h1>
                <h1 style={{
                    fontFamily: "RO",
                  }}
                className="text-[8rem] md:text-[12rem] font-extralight">New Inspo</h1>
                <video
                    src="/videos/17.mp4"
                    autoPlay
                    width="600"
            ...
            <div 
            id='cards'
            className='overflow-hidden pt-40 w-full z-0' ref={containerRef}>
            ...
            <div>
                ...
                >
                    <h5 className="text-xl font-semibold cursor-grab select-none text-white"> Drag </h5>
                </div>
                <motion.div
